...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' SDE at Hewlett Packard Enterprice ', "Cricket Lover ", " Mentor ", " Open Source Contributer ",'Software Developer ', " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Sumantha Prabhu</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/suprabhu77" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/sumanth-prabhu-5000a8190/" target="_blank">
          <ImLinkedin />
        </a>
        <a
