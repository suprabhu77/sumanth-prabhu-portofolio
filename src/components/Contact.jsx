  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Sumanth Prabhu",
          from_email: form.email,
          to_email: "sumanthprabhu2000@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:sumanthprabhu2000@gmail.com" target="_blank" className="blue-text-gradient">sumanthprabhu2000@gmail.com</a>
          </article>
        </div>
      </motion.div>
    </div>
